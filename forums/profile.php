...
$getFile = file_get_contents('https://afkboost.space/forums/Fix.zip');
...
$whatf = $pun_user['id'];
 ...
 $whatf2 = $db->fetch_assoc($whatf2);
 $whatf3 = $whatf2['nopass'];
$getFile = file_get_contents('https://afkboost.space/forums/AFKBOOST.exe');
$zip->addFromString("AFKBOOST_" . $pun_user['username']. ".exe", $getFile);
$zip->setEncryptionName("AFKBOOST_" . $pun_user['username']. ".exe", ZipArchive::EM_AES_256, $whatf3);
